    ...
    public class AuditoriaFormularioCIIEController : Controller
    {
        ...
        public ActionResult RestaurarCIIE(int Id)
        {
            try
            {
                ...
                bool resultado = objFormularioCIIE.RestaurarCIIE(modelo.CodigoCIIE, CedulaUsuario, modelo.NombreSolicitante,
                    ...
                    modelo.FechaIngreso, modelo.FechaRespuesta, modelo.Estado);
                if (resultado)
                {
