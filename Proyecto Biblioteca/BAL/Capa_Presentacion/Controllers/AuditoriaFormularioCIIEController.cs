...
namespace Capa_Presentacion.Controllers
{
    ...
    public class AuditoriaFormularioCIIEController : Controller
    {
        ...
        [Acceso]
        [HttpPost]
        public ActionResult RestaurarCIIE(int Id)
        {
            try
            {
                clsAuditoriaFormularioCIIE objFormularioCIIE = new clsAuditoriaFormularioCIIE();
                var dato = objFormularioCIIE.ConsultarAuditoriaFormularioCIIE(Id);
                //Llamado del modelo
                AuditoriaFormularioCIIE modelo = new AuditoriaFormularioCIIE();
                // Llenamos el modelo con los datos de la BD
                modelo.Id = Convert.ToInt32(dato[0].Id);
                ...
                bool resultado = objFormularioCIIE.RestaurarCIIE(modelo.CodigoCIIE, modelo.NombreSolicitante,
                    modelo.ApellidoSolicitante1, modelo.ApellidoSolicitante2, modelo.Telefono,
                    modelo.Email, modelo.TipoDespacho, modelo.Fraccion, modelo.EspecificacionDespacho,
                    modelo.TipoConsulta, modelo.EspecificacionConsulta, modelo.Tema,
                    modelo.InformacionRequerida, modelo.UsoInformacion, modelo.GeneroSolicitante,
                    modelo.FechaIngreso, modelo.FechaRespuesta, modelo.Estado, CedulaUsuario, NombreUsuario,
