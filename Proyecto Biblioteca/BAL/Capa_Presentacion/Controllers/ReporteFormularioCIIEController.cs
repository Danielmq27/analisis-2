...
namespace Capa_Presentacion.Controllers
{
    ...
    {
        //Vista para el rol Administrador
        public ActionResult Administrador()
        {
            return View();
        }

        //Vista para el rol Editar
        public ActionResult Editar()
        {
            return View();
        }

        //Vista de la cantidad de tipos de usuario por fechas de ingreso
        ...
        //Vista de la cantidad de tipos de usuario por fechas de respuesta
        ...
        //Vista de la cantidad de tipos de usuario por fechas de ingreso y fechas de respuesta
